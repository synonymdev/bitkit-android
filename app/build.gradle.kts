...
val pushRegistrationEnabledEnv = envFlag("PUSH_REGISTRATION_ENABLED", default = true)
...
androidComponents {
    onVariants { variant ->
        ...
        buildConfigFields.put("PUSH_REGISTRATION_ENABLED", pushRegistrationEnabledEnv.booleanField())
