    ...
    fun onConnectionContinue(peer: PeerDetails) {
        viewModelScope.launch {
            ...
            if (result.isSuccess) {
                ...
                toaster.error(
                    title = ToastText(R.string.lightning__error_add_title),
                    body = ToastText(R.string.lightning__error_add),
                )
            }
        }
    }
    ...
    fun parseNodeUri(uriString: String) {
        viewModelScope.launch {
            ...
            if (result.isSuccess) {
                ...
                toaster.error(title = ToastText(R.string.lightning__error_add_uri))
            }
        }
    }
