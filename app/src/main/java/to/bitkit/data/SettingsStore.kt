...
class SettingsStore @Inject constructor(
    ...
    val hasSeenShopIntro: Flow<Boolean> = store.data.map { it[HAS_SEEN_SHOP_INTRO] == true }
    suspend fun setHasSeenShopIntro(value: Boolean) {
        store.edit { it[HAS_SEEN_SHOP_INTRO] = value }
    }
    ...
    private companion object {
        ...
        private val HAS_SEEN_SHOP_INTRO = booleanPreferencesKey("has_seen_shop_intro")
