...
| [deeplinks](deeplinks) | 3 | `bitkit://screen/…` and sheet routing behind the dev-mode gate, plus the hardware spending sign link; needs a paired hardware wallet for that one; no README |
